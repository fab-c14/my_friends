...
function App(store) {
  ...
  const onSearchChange = useSelector((state)=>state.onSearchChange)
  ...
  useEffect(() => {
    // console.log(store.this.state.first());
    fetch("https://jsonplaceholder.typicode.com/users") // request to server
      .then((response) => {
        return response.json();
      })
...
// export default connect()(App);// connect is a higher order function

export default connect(mapStateToProps, mapDispatchToProps)(App);
// what action should i listen what should i do